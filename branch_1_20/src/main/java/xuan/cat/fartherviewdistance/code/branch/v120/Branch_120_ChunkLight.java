...
public final class Branch_120_ChunkLight implements BranchChunkLight {
  ...
  public Branch_120_ChunkLight(World world) {
    this(((CraftWorld) world).getHandle());
  }

  public Branch_120_ChunkLight(ServerLevel worldServer) {
    this(
      worldServer,

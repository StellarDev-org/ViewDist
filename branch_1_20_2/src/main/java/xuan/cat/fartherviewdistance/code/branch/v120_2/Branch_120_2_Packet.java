...
public final class Branch_120_2_Packet implements BranchPacket {

  private final Branch_120_2_PacketHandleChunk handleChunk = new Branch_120_2_PacketHandleChunk();
  private final Branch_120_2_PacketHandleLightUpdate handleLightUpdate = new Branch_120_2_PacketHandleLightUpdate();
  ...
  public Consumer<Player> sendChunkAndLight(
    ...
    this.handleChunk.write(
        serializer,
        ((Branch_120_2_Chunk) chunk).getLevelChunk(),
        needTile
      );
    this.handleLightUpdate.write(serializer, (Branch_120_2_ChunkLight) light);

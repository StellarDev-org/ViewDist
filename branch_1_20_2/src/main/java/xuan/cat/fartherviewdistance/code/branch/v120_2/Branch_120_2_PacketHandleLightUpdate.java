...
public final class Branch_120_2_PacketHandleLightUpdate {

  public Branch_120_2_PacketHandleLightUpdate() {}

  public void write(FriendlyByteBuf serializer, Branch_120_2_ChunkLight light) {
  ...
  private static void saveBitSet(
    ...
    if (nibbleArray != Branch_120_2_ChunkLight.EMPTY) {
      if (nibbleArray == null) {
        isEmpty.set(index);
      } else {
        notEmpty.set(index);
